...
class DropitViewController: UIViewController,UIDynamicAnimatorDelegate {
    ...
    let dropitBehvaior = DropitBehavior()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        animator.addBehavior(dropitBehvaior)
    }
    ...
    override func viewDidLayoutSubviews() {
        ...
        dropitBehvaior.addBarrier(path, named: PathNames.MiddleBarrier)
   ...
   var dropsPerRow = 10
    ...
    func drop(){
        ...
        dropitBehvaior.addDrop(dropView)
    }
    ...
    func removeCompleteRow(){
        ...
        for drop in dropsToRemove {
            dropitBehvaior.removeDrop(drop)
        }
    }
